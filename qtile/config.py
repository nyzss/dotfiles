...
keys = [
    ...
    Key([mod], "r", lazy.spawn("launcher_t1"), desc="Spawn a command using rofi."),
...
layouts = [
    layout.Bsp(
        ...
        border_focus_stack=["#8340f7", "#8340f7"],
        border_width=4,
        margin_on_single=32,
        margin=12,
    ),
    ...
    Screen(
        bottom=bar.Bar(
            [
                ...
                widget.TextBox("nyzs", name="default"),
...
# @hook.subscribe.startup_once
# def autostart():
#     # processes = [["nitrogen", "--restore"], ["~/.config/picom/start"], ["polybar"]]
#     processes = [["nitrogen", "--restore"], ["~/.config/picom/start"], ["polybar"]]
#
#     for p in processes:
#         subprocess.Popen(p)
